...
describe('YouTube Video', () => {
    ...
    it('should override default params with rmstweb parmas', async () => {
    ...
    it('should work if settingsParams and rmstweb params not provided', async () => {
        const url = '//www.youtube.com/watch?v=EIUJfXk3_3w';
        const videoInfo = utils.isVideo(url, false, 0);
        const settingParam = false;
        const params = getYouTubeParams(videoInfo as VideoInfo, settingParam);
    ...
    it('should override settings params with rmstweb params', async () => {
