...
export interface LightGalleryCoreSettings {
     ...
     * data-rmstweb="img-1600.jpg" </code>
     *
     ...
     * @description By default download url will be taken from data-rmstweb/href attribute but it supports only for modern browsers.
    ...
    /**
     * An array of objects (rmstweb, iframe, subHtml, thumb, poster, responsive, srcset sizes) representing gallery elements.
     */
     ...
     * HTML:
     * <div id="lightGallery">
     *     <a href="a.jpg" data-custom-prop="abc"><img rmstweb="thumb.jpg" /></a>
     *     <a href="a.jpg" data-custom-prop="xyz"><img rmstweb="thumb.jpg" /></a>
     * </div>
     * JS:
     ...
     * @example
     * <div id="lightGallery">
     *     <a href="a.jpg" data-external-thumb-image="images/externalThumb.jpg" ><img rmstweb="thumb.jpg" /></a>
     * </div>
     *
     * lightGallery(document.getElementById('lightGallery'), {
